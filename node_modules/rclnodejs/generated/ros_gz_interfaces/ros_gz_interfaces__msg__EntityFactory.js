...
class EntityFactoryWrapper {
  ...
  static type() {
    return {pkgName: 'ros_gz_interfaces', subFolder: 'msg', interfaceName: 'EntityFactory'};
  }
  static isPrimitive() {
    return false;
  }
