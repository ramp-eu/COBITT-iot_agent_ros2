...
class TrackVisualWrapper {
  ...
  static type() {
    return {pkgName: 'ros_gz_interfaces', subFolder: 'msg', interfaceName: 'TrackVisual'};
  }
  static isPrimitive() {
    return false;
  }
