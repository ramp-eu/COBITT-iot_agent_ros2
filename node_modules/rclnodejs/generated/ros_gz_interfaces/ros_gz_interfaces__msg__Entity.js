...
class EntityWrapper {
  ...
  freeze(own = false, checkConsistency = false) {
    if (checkConsistency) {
      if (!this._idIntialized) {
        throw new TypeError('Invalid argument: id in Entity');
      }
      if (!this._nameIntialized) {
        throw new TypeError('Invalid argument: name in Entity');
      }
      if (!this._typeIntialized) {
        throw new TypeError('Invalid argument: type in Entity');
      }
    }
    if (own) {
  ...
  static type() {
    return {pkgName: 'ros_gz_interfaces', subFolder: 'msg', interfaceName: 'Entity'};
  }
  static isPrimitive() {
    return false;
  }
...
Object.defineProperty(EntityWrapper, "NONE", {value: 0, writable: false, enumerable: true, configurable: true});
Object.defineProperty(EntityWrapper, "LIGHT", {value: 1, writable: false, enumerable: true, configurable: true});
Object.defineProperty(EntityWrapper, "MODEL", {value: 2, writable: false, enumerable: true, configurable: true});
Object.defineProperty(EntityWrapper, "LINK", {value: 3, writable: false, enumerable: true, configurable: true});
Object.defineProperty(EntityWrapper, "VISUAL", {value: 4, writable: false, enumerable: true, configurable: true});
Object.defineProperty(EntityWrapper, "COLLISION", {value: 5, writable: false, enumerable: true, configurable: true});
Object.defineProperty(EntityWrapper, "SENSOR", {value: 6, writable: false, enumerable: true, configurable: true});
Object.defineProperty(EntityWrapper, "JOINT", {value: 7, writable: false, enumerable: true, configurable: true});
